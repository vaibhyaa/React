...
const TravelApp = () => {
  // so lifting up state can be used at sibling , deepely nested , child components
  // lfting up the state because this used in child components (Form and packingList and stats)
  const [items, setitems] = useState([]);

  function handleAddItems(newItem) {
    // existingitems refere to the existing state items in array becaue after adding new item , component re-render so all existing items with new item should display
